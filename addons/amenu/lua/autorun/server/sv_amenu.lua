...
AddCSLuaFile("amenu/vgui/cl_circleavatar.lua")
AddCSLuaFile("amenu/vgui/cl_circles.lua")
AddCSLuaFile("amenu/vgui/cl_acategory.lua")
AddCSLuaFile("amenu/vgui/cl_amenubutton.lua")
AddCSLuaFile("amenu/vgui/cl_alistview.lua")
...
AddCSLuaFile("amenu/cl_gangs.lua")
